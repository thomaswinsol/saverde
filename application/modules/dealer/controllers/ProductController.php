...
class dealer_ProductController extends My_Controller_Action
{
    public function detailAction()
    {
         ...
         if (!empty($id)) {
              ...
              $this->view->fotoform = new dealer_Form_Autocomplete(null,$params);
              ...
              $this->view->categorieform = new dealer_Form_Autocomplete(null,$params);
    ...
    public function selecteerAction()
    {
        ...
        $this->_helper->redirector('detail', 'product', 'dealer', $params);
    }
